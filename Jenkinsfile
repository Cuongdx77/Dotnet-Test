pipeline {
  ...
  stages {
    ...
    stage('Quality Gate') {
      ...
      steps {
        script {
          def response = sh(script: curl -u "sqa_1930a831282b897e091d3074560eb2ef2e0bf5c8:" "10.26.2.215:9000/api/qualitygates/project_status?projectKey=test-sonarqube" | jq -r '.projectStatus.status')
          if (response == 'OK') {
